...
public class MPManager : MonoBehaviour
{
    ...
    [Header("Target")]
    private List<ITurn> targets = new List<ITurn>();            // 공격 타겟
    ...
    public bool CheckCondition()
    {
        ...
        switch (MPData.conditionType)
        {
            ...
            case MasterPieceData.ConditionType.OverCost:
                addValue = stack / MPData.perCondition; // 여분 코스트 / 필요 수치
                ClearStack();                           // 스택 초기화
            ...
            case MasterPieceData.ConditionType.Paint:   // 빨간색 물감
                int colorType = MPData.conditionColorType;
    ...
    // 걸작스킬 사용
    public void ExecuteMasterPiece()
    {
        Debug.Log($"{MPData.MP_Name}걸작 발동!");
